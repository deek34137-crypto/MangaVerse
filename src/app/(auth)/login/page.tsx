  ...
  return (
    <div className="relative my-6">
      ...
      <div className="relative flex justify-center">
        <span className="bg-card px-4 text-xs text-muted-foreground uppercase tracking-wider font-medium">
...
function OAuthButton({
  ...
  const handleClick = async () => {
    onLoadingChange(provider.id);
    await signIn(provider.id, { callbackUrl: "/" });
    onLoadingChange(null);
  };

  const busy = isLoading === provider.id;
  ...
  return (
    <motion.button
      ...
      onClick={handleClick}
      disabled={!!isLoading}
      className={cn(provider.className, "disabled:opacity-50 disabled:cursor-not-allowed")}
    ...
    >
      ...
      <span>{busy ? `Connecting to ${provider.name}…` : `Continue with ${provider.name}`}</span>
    </motion.button>
  );
}
        ...
        <div className="relative z-10 max-w-md px-8 text-center space-y-6">
          ...
          >
            ...
            <p className="text-body-md text-muted-foreground leading-relaxed">
              Track your reading journey, discover new series, and join a community of manga enthusiasts.
            </p>
          </motion.div>
          ...
          >
            {[
              { value: "50K+", label: "Manga Titles" },
              { value: "1M+", label: "Chapters" },
      ...
      >
        ...
        <div className="w-full max-w-[420px] relative z-10">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm">Sign in to continue your manga journey</p>
          </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs text-primary hover:text-primary-hover transition-colors hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
              ...
              <label className="flex items-center gap-2.5 cursor-pointer group">
                <input
                  ...
                  onChange={(e) => setFormData((d) => ({ ...d, remember: e.target.checked }))}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-primary text-primary-foreground font-semibold text-sm hover:bg-primary-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-primary/30"
              >
                {isLoading ? (
                  <>
          ...
          >
            ...
            <Link href="/register" className="text-primary font-medium hover:text-primary-hover transition-colors hover:underline">
              Create one for free
            </Link>
          </motion.p>
        </div>
