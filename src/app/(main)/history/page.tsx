...
import { Calendar, Clock, BookOpen, Trash2, Filter, X, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function HistoryPage() {
  const [groupedByDate, setGroupedByDate] = useState<Record<string, typeof mockHistory>>({});
